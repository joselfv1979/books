...
const Notification = () => {
    ...
    return (
        <div
            data-testid="alert"
            role="alert"
            className={`fixed top-4 left-1/2 transform -translate-x-1/2 z-50 min-w-[250px] max-w-md px-4 py-3 border ${bgColor} rounded shadow-lg flex items-center justify-between`}
        >
