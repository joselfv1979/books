...
export const borrowCopy = async (userId: string, bookId: string): Promise<Result<LoanWithBookInfo, string>> => {
    try {
...
export const getLoansByUser = async (userId: string): Promise<Result<LoanWithBookInfo[], string>> => {
    try {
